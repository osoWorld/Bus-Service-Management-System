...
public class AddNewEmployee extends JFrame {
    ...
    private void initializeGUI() {
        ...
        JLabel titleLabel = new JLabel("Add New Employee in Admin Dream Travels");
        ...
        customerDetailsRectangle.setLayout(new GridLayout(0, 2, 1, 40));
        ...
        String[] labelsAdminEmployee = {"Employee Id:", "Employee Role:", "Employee Status", "Employee Salary:", "Employee Login Email:", "Employee Login Password:"};
    ...
    private void showEmployeeDetailsInReceipt(JTextPane textReceiptPane) {
        ...
        try {
            ...
            styledDocument.insertString(styledDocument.getLength(), " Employee Role : ", boldStyle);
    ...
    private void getValue() {
        ...
        saveToDatabase(employeeId, fullName, fatherName, phoneNumber, cnicNumber, reference, experience, employeeRole, employeeStatus, employeeSalary, employeeLoginEmail, employeeLoginPassword, formattedDateTime);
    }

    private void saveToDatabase(String employeeId, String fullName, String fatherName, String phoneNumber, String cnicNumber, String reference, String experience, String employeeRole, String employeeStatus, String employeeSalary, String employeeLoginEmail, String employeeLoginPassword, String joiningDate) {
        Connection connection = null;
        try {
            connection = DriverManager.getConnection("jdbc:ucanaccess://E://Dream Travels Database//Dream_Travels.accdb");
            String sql = "INSERT INTO [Employee_Details] ([Employee ID], [Employee Full Name], [Employee Father], [Phone Number], [CNIC NUMBER], [Reference], [Experience], [Employee Role], [Employee Status], [Employee Salary], [Employee Login Email], [Employee Login Password], [Joining Date]) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            preparedStatement.setString(8, employeeRole);
            preparedStatement.setString(9, employeeStatus);
            preparedStatement.setString(10, employeeSalary);
            preparedStatement.setString(11, employeeLoginEmail);
            preparedStatement.setString(12, employeeLoginPassword);
            preparedStatement.setString(13, joiningDate);

            preparedStatement.executeUpdate();

            try {
                String sqlAuth = "INSERT INTO [EmployeeAuth] ([Email], [Password]) " +
                        "VALUES (?, ?)";
                ...
                try {
                    String sqlEmpReceipt = "INSERT INTO [Employee_Receipt] ([Employee ID], [Employee Name], [Employee Role], [Employee Salary]) " +
                            "VALUES (?, ?, ?, ?)";

                    PreparedStatement preparedStatementEmpReceipt = connection.prepareStatement(sqlEmpReceipt);
                    preparedStatementEmpReceipt.setString(1, employeeId);
                    preparedStatementEmpReceipt.setString(2, fullName);
                    preparedStatementEmpReceipt.setString(3, employeeRole);
                    preparedStatementEmpReceipt.setString(4, employeeSalary);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AddNewEmployee::new);
    }
}
